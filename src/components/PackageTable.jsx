...
const PackageTable = () => {
  ...
  const fetchPackages = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/packages', config);
      setIsLoading(false);
  ...
  const fetchSources = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/places', config);
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/hotels', config);
  ...
  const fetchTransports = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/transports', config);
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this package?')) {
      try {
        await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/packages/${id}`, config);
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://travel-backend-jr66.onrender.com/api/admin/packages/${editId}`, updatedPackageData, config);
