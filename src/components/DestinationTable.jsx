...
const DestinationTable = () => {
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/places/${id}`, config);
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://travel-backend-jr66.onrender.com/api/admin/places/${editId}`, editFormData, config);
