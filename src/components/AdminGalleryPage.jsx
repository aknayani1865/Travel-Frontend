...
const AdminGalleryPage = () => {
  ...
  useEffect(() => {
    const fetchPhotos = async () => {
      try {
        const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/gallery', config);
  ...
  const handleRemovePhoto = async (id) => {
    ...
    try {
      await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/gallery/${id}`, config);
