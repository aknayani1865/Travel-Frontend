...
const SourceTable = () => {
  ...
  const fetchSources = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/sources', config); // API route for sources
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/sources/${id}`, config);
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://travel-backend-jr66.onrender.com/api/admin/sources/${editId}`, editFormData, config);
