    ...
    useEffect(() => {
        const fetchPackageDetails = async () => {
            try {
                ...
                const response = await axios.get(`https://travel-backend-jr66.onrender.com/api/admin/packages/${packageId}`, config);
                setPackageDetails(response.data);
                
                // Fetch applied users separately
                const usersResponse = await axios.get(`https://travel-backend-jr66.onrender.com/api/admin/packages/${packageId}/applied-users`, config);
