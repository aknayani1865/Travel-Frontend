...
const HotelTable = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('https://travel-backend-jr66.onrender.com/api/admin/hotels', config); // Adjust your API route as necessary
  ...
  const handleDelete = async (id) => {
    ...
    if (confirmDelete) {
      try {
        await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/hotels/${id}`, config);
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://travel-backend-jr66.onrender.com/api/admin/hotels/${editId}`, editFormData, config);
