...
const TransportTable = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this transport?')) {
      try {
        await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/transports/${id}`, config);
  ...
  const handleEditFormSubmit = async (event) => {
    ...
    try {
      await axios.put(`https://travel-backend-jr66.onrender.com/api/admin/transports/${editId}`, editFormData, config);
