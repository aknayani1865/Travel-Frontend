...
const AddPackage = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [sourcesRes, destinationsRes, hotelsRes, transportsRes] = await Promise.all([
          axios.get('https://travel-backend-jr66.onrender.com/api/admin/places', config),
          axios.get('https://travel-backend-jr66.onrender.com/api/admin/places', config),
          axios.get('https://travel-backend-jr66.onrender.com/api/admin/hotels', config),
          axios.get('https://travel-backend-jr66.onrender.com/api/admin/transports', config)
        ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://travel-backend-jr66.onrender.com/api/admin/packages', packageData, config);
      setPackageData({
        name: '',
        sourceId: '',
        destinationId: '',
