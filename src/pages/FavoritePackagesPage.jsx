...
const FavoritePackagesPage = () => {
  ...
  useEffect(() => {
    const fetchFavorites = async () => {
      try {
        const response = await axios.get(`https://travel-backend-jr66.onrender.com/api/admin/users/${userId}/favorites`, config);
  ...
  useEffect(() => {
    const fetchAppliedPackages = async () => {
      try {
        const response = await axios.get(`https://travel-backend-jr66.onrender.com/api/admin/user/${userId}/bookings`, config);
  ...
  const handleRemoveFavorite = async (pkgId) => {
    try {
      await axios.delete(`https://travel-backend-jr66.onrender.com/api/admin/users/${userId}/favorites/${pkgId}`, config);
