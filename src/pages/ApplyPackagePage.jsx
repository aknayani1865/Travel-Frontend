  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookingResponse = await axios.post(
        `https://travel-backend-jr66.onrender.com/api/admin/packages/${pkg._id}/apply`,
        {
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          try {
            ...
            const verifyResponse = await axios.post('https://travel-backend-jr66.onrender.com/api/admin/payment/verify', {
